...
uint8_t BSP_GYRO_Init(void)
{
  ...
  if((L3gd20Drv.ReadID() == I_AM_L3GD20) || (L3gd20Drv.ReadID() == I_AM_L3GD20_TR))
  {
    ...
    Gyro_InitStructure.Full_Scale       = L3GD20_FULLSCALE_2000;
  ...
  else if (I3g4250Drv.ReadID() == I_AM_I3G4250D)
  {
    ...
    Gyro_InitStructure.Full_Scale       = I3G4250D_FULLSCALE_2000;
    ...
    Gyro_FilterStructure.HighPassFilter_Mode_Selection   = I3G4250D_HPM_NORMAL_MODE;
