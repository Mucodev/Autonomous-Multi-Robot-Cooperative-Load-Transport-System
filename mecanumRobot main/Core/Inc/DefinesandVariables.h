...
/* FIXED FORMATION MULTI-ROBOT */
// Set this value for each robot: 1, 2, 3
#define ROBOT_ID 1  // CHANGE THIS FOR EACH ROBOT!
...
#define POSITION_THRESHOLD 0.00f // Position accuracy threshold in meters

#define ENCODER_PPR       12    // Pulses per revolution (before gearing)
#define GEAR_RATIO        84    // Motor gear ratio (84:1) -> 110rpm / Motor Gear ratio (150:1) -> 60rpm
