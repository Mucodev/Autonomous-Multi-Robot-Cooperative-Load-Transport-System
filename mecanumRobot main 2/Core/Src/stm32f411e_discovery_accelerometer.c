...
uint8_t BSP_ACCELERO_Init(void)
{
  ...
  if(Lsm303dlhcDrv.ReadID() == I_AM_LMS303DLHC)
  {
    ...
    Accelero_InitStructure.AccOutput_DataRate = LSM303DLHC_ODR_100_HZ;
    Accelero_InitStructure.Axes_Enable        = LSM303DLHC_AXES_ENABLE;
    Accelero_InitStructure.AccFull_Scale      = LSM303DLHC_FULLSCALE_16G;
    ...
    Accelero_FilterStructure.HighPassFilter_CutOff_Frequency = LSM303DLHC_HPFCF_8;
  ...
  else if(Lsm303agrDrv.ReadID() == I_AM_LSM303AGR)
  {
    ...
    Accelero_InitStructure.AccOutput_DataRate = LSM303AGR_ODR_100_HZ;
    Accelero_InitStructure.Axes_Enable        = LSM303AGR_AXES_ENABLE;
    Accelero_InitStructure.AccFull_Scale      = LSM303AGR_FULLSCALE_16G;
    ...
    Accelero_FilterStructure.HighPassFilter_CutOff_Frequency = LSM303AGR_HPFCF_8;
