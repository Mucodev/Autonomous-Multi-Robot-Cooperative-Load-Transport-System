...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  else if(hi2c->Instance==I2C3)
  {
    ...
    PA8     ------> I2C3_SCL
    */
    GPIO_InitStruct.Pin = slave_sda_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C3;
    HAL_GPIO_Init(slave_sda_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = slave_scl_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C3;
    HAL_GPIO_Init(slave_scl_GPIO_Port, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  else if(hi2c->Instance==I2C3)
  {
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(slave_sda_GPIO_Port, slave_sda_Pin);

    HAL_GPIO_DeInit(slave_scl_GPIO_Port, slave_scl_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB13     ------> SPI2_SCK
    */
    GPIO_InitStruct.Pin = espcam_miso_Pin|espcam_mosi_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = espcam_nss_Pin|espcam_sck_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB13     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, espcam_miso_Pin|espcam_mosi_Pin);

    HAL_GPIO_DeInit(GPIOB, espcam_nss_Pin|espcam_sck_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, enc3_a_Pin|enc3_b_Pin);
